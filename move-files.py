...
destination_dir = r'C:\Users\Username\Documents'
...
for filename in os.listdir(source_dir):
    ...
    if os.path.isfile(os.path.join(source_dir, filename)):
        ...
        if file_ext == '.pdf':
            ...
            dest_dir = os.path.join(destination_dir, 'Word_Documents')
        elif file_ext in ['.xls', '.xlsx']:
            dest_dir = os.path.join(destination_dir, 'Excel_Spreadsheets')
        else:
            dest_dir = os.path.join(destination_dir, 'Other_Files')
